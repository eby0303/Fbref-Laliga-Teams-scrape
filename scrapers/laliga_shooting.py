...
def process_shooting_stats(year, team):
    """Process shooting statistics dynamically for any team and season."""
    logger.info(f"Starting shooting stats scraping for {team} in {year}")
    ...
    try:
        ...
        logger.error(f"Error in process_shooting_stats for {team} ({year}): {str(e)}")
        raise
